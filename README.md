...
Standardized text data (e.g., converting 'M'/'S' to 'Married'/'Single').
Created custom age brackets using nested IF statements to group customers into Adolescent, Middle Age, and Old categories.
Data Analysis: Built Pivot Tables to aggregate metrics, such as average income and customer commute distances, categorized by purchase status.
